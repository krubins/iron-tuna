...
Posts to **@irontunafantasy** every **Monday, Wednesday, Friday at 14:00 UTC** (10am ET / 9am during EST) — one auction insight + one snake insight per run, **plus a third post on Wednesdays only** (money-allocation strategy / Value Coach promo, alternating). Runs via a Cloudflare Worker **Cron Trigger**, no external scheduler needed.
