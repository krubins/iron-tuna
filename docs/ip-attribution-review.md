...
| 8 | **Underdog / PrizePicks / Sleeper pick'em labels** | `/dfs`, `/in-season` | Nominative use of trademarks to name a contest format. No data is read from any of them. | Named on `/data` under trademarks | N/A | **LOW.** |
